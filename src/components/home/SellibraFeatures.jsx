...
import { FaPalette, FaFont, FaEraser, FaCalculator } from 'react-icons/fa';

const SellibraFeatures = () => {
  ...
  const etsyAiTools = [
    {
      ...
      icon: <FaPalette />,
      name: 'Text to Image',
      description: 'Metin açıklamalarından profesyonel görsel tasarımları oluşturun'
    },
    {
      id: 'image-to-image',
      icon: <FaPalette />,
      name: 'Image to Image',
      description: 'Mevcut görselleri AI ile yeniden tasarlayın ve iyileştirin'
    },
    {
    ...
    },
    {
      ...
      description: 'SEO uyumlu, dikkat çekici ürün başlıkları oluşturun'
    },
    {
      id: 'description-generator',
      icon: <FaFont />,
      name: 'Description Generator',
      description: 'Etsy algoritmasına uygun detaylı ürün açıklamaları yazın'
    },
    {
      id: 'profit-calculator',
      icon: <FaCalculator />,
      name: 'Profit Calculator',
      description: 'Kar marjınızı hesaplayın ve fiyatlandırma stratejisi belirleyin'
    }
  ];
          ...
          <div className="feature-module-card">
            <div className="module-card-header">
              <div className="module-logo">
                <img src="/integrations/printnest_logo-BSbxRoeY.svg" alt="PrintNest" />
              </div>
              <h3 className="module-title">PrintNest Entegrasyonu</h3>
            </div>
            <p className="module-description">
              Baskı merkezi entegrasyonu ile siparişten üretime tüm süreci tek panelden yönetin.
            </p>
            <ul className="module-features-list">
              <li>Gerçek zamanlı sipariş takibi</li>
              <li>Otomatik ürün senkronizasyonu</li>
              <li>Stok ve envanter yönetimi</li>
              <li>Hızlı teslimat koordinasyonu</li>
            </ul>
          </div>

          {/* Etsy-AI Tools Card */}
          <div className="feature-module-card etsy-ai-card">
            <div className="module-card-header">
              <div className="module-logo">
              ...
              <h3 className="module-title">Etsy-AI Tools</h3>
            </div>
            <p className="module-description">
            ...
            <div className="ai-tools-grid">
              {etsyAiTools.map((tool) => (
                ...
                >
                  ...
                  {hoveredTool === tool.id && (
                    <div className="ai-tool-detail-card">
                      <h4 className="tool-detail-title">{tool.name}</h4>
...
export default SellibraFeatures;
